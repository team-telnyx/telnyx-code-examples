...
Build a production-ready ASP.NET application that sends SMS survey questions and collects responses via inbound webhooks using the Telnyx SMS API.
...
| Method | Path | Purpose |
|--------|------|---------|
| `POST` | `start` | API endpoint |
| `POST` | `webhooks/sms` | Webhook handler |
| `GET` | `results/{phoneNumber}` | API endpoint |
...
- [Source code](https://raw.githubusercontent.com/team-telnyx/telnyx-code-examples/main/sms-survey-bot-csharp/README.md)
- [API reference](https://raw.githubusercontent.com/team-telnyx/telnyx-code-examples/main/sms-survey-bot-csharp/API.md)
- [Messaging Documentation](https://developers.telnyx.com/docs/messaging)
