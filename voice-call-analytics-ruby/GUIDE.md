...
Build a production-ready Sinatra application that tracks call metrics and analytics using the Telnyx Voice API.
...
| `GET` | `/analytics/calls/:call_control_id` | API endpoint |
...
- [Source code](https://raw.githubusercontent.com/team-telnyx/telnyx-code-examples/main/voice-call-analytics-ruby/README.md)
- [API reference](https://raw.githubusercontent.com/team-telnyx/telnyx-code-examples/main/voice-call-analytics-ruby/API.md)
- [Voice API Documentation](https://developers.telnyx.com/docs/voice)
