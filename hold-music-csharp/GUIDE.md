...
Build a production-ready ASP.NET Core application that places callers on hold with custom music using the Telnyx Voice API.
...
- [Source code](https://raw.githubusercontent.com/team-telnyx/telnyx-code-examples/main/hold-music-csharp/README.md)
- [API reference](https://raw.githubusercontent.com/team-telnyx/telnyx-code-examples/main/hold-music-csharp/API.md)
- [Voice API Documentation](https://developers.telnyx.com/docs/voice)
