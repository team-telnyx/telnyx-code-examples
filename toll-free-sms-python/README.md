...
| `TELNYX_PUBLIC_KEY` | `string` | `o5x...base64...` | **yes** | Public key used to verify inbound webhook signatures | [Portal](https://portal.telnyx.com/api-keys) · [CLI: `telnyx auth`](https://developers.telnyx.com/development/cli) (Public Key) |
