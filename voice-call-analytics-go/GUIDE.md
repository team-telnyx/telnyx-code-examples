...
Build a production-ready Gin web service that tracks call metrics and analytics using the Telnyx Voice API.
...
- [Source code](https://raw.githubusercontent.com/team-telnyx/telnyx-code-examples/main/voice-call-analytics-go/README.md)
- [API reference](https://raw.githubusercontent.com/team-telnyx/telnyx-code-examples/main/voice-call-analytics-go/API.md)
- [Voice API Documentation](https://developers.telnyx.com/docs/voice)
