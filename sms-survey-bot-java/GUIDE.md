...
Build a production-ready Spring Boot application that sends SMS survey questions and collects responses via inbound webhooks.
...
- [Source code](https://raw.githubusercontent.com/team-telnyx/telnyx-code-examples/main/sms-survey-bot-java/README.md)
- [API reference](https://raw.githubusercontent.com/team-telnyx/telnyx-code-examples/main/sms-survey-bot-java/API.md)
- [Messaging Documentation](https://developers.telnyx.com/docs/messaging)
