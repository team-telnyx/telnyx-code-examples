...
Build a production-ready Spring Boot application that sends SMS notifications using the Telnyx Java SDK.
...
- [Source code](https://raw.githubusercontent.com/team-telnyx/telnyx-code-examples/main/send-sms-notifications-java/README.md)
- [API reference](https://raw.githubusercontent.com/team-telnyx/telnyx-code-examples/main/send-sms-notifications-java/API.md)
- [Messaging Documentation](https://developers.telnyx.com/docs/messaging)
