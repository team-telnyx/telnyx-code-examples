...
Build a production-ready Gin web service that tracks IoT device locations using Telnyx SIM cards.
...
| `GET` | `/devices/:sim_card_id` | API endpoint |
...
- [Source code](https://raw.githubusercontent.com/team-telnyx/telnyx-code-examples/main/track-iot-device-location-go/README.md)
- [API reference](https://raw.githubusercontent.com/team-telnyx/telnyx-code-examples/main/track-iot-device-location-go/API.md)
- [IoT SIM Management Documentation](https://developers.telnyx.com/docs/iot)
