...
Build a production-ready Gin endpoint that performs CNAM (Caller Name) lookups using the Telnyx Go SDK.
...
- [Source code](https://raw.githubusercontent.com/team-telnyx/telnyx-code-examples/main/sip-cnam-lookup-go/README.md)
- [API reference](https://raw.githubusercontent.com/team-telnyx/telnyx-code-examples/main/sip-cnam-lookup-go/API.md)
- [SIP Trunking Documentation](https://developers.telnyx.com/docs/sip-trunking)
