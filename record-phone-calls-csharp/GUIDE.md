...
Build a production-ready ASP.NET Core application that initiates outbound calls and records them using the Telnyx Voice API.
...
| `POST` | `webhooks/events` | Webhook handler |
...
- [Source code](https://raw.githubusercontent.com/team-telnyx/telnyx-code-examples/main/record-phone-calls-csharp/README.md)
- [API reference](https://raw.githubusercontent.com/team-telnyx/telnyx-code-examples/main/record-phone-calls-csharp/API.md)
- [Voice API Documentation](https://developers.telnyx.com/docs/voice)
