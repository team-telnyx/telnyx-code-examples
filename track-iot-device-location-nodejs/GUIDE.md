...
Build a production-ready Express application that tracks SIM card device locations using the Telnyx IoT API.
...
| `GET` | `/sim-cards/:id/location` | API endpoint |
| `POST` | `/webhooks/sim-status` | Webhook handler |
...
- [Source code](https://raw.githubusercontent.com/team-telnyx/telnyx-code-examples/main/track-iot-device-location-nodejs/README.md)
- [API reference](https://raw.githubusercontent.com/team-telnyx/telnyx-code-examples/main/track-iot-device-location-nodejs/API.md)
- [IoT SIM Management Documentation](https://developers.telnyx.com/docs/iot)
