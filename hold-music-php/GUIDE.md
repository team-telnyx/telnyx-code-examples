...
Build a production-ready Laravel application that places callers on hold with custom music using the Telnyx Voice API.
...
| `POST` | `/calls/status` | API endpoint |
...
- [Source code](https://raw.githubusercontent.com/team-telnyx/telnyx-code-examples/main/hold-music-php/README.md)
- [API reference](https://raw.githubusercontent.com/team-telnyx/telnyx-code-examples/main/hold-music-php/API.md)
- [Voice API Documentation](https://developers.telnyx.com/docs/voice)
