...
## `PATCH sip-connections/{connectionId}/password`

Update data at `sip-connections/{connectionId}/password`.
...
```bash
curl -X PATCH http://localhost:5000sip-connections/{connectionId}/password \
