...
Build a production-ready Sinatra application that handles voicemail using the Telnyx Voice API.
...
| `GET` | `/voicemails/:call_control_id` | API endpoint |
...
- [Source code](https://raw.githubusercontent.com/team-telnyx/telnyx-code-examples/main/voicemail-ruby/README.md)
- [API reference](https://raw.githubusercontent.com/team-telnyx/telnyx-code-examples/main/voicemail-ruby/API.md)
- [Voice API Documentation](https://developers.telnyx.com/docs/voice)
