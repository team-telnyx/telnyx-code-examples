...
| [patient-agent](https://raw.githubusercontent.com/team-telnyx/telnyx-code-examples/main/patient-agent/README.md) | Typescript | A durable agent that tracks appointments, medication adherence, and proactively checks in via SMS — the actor IS the patient. |
