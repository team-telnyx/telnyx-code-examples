...
<details open>
<summary><h2>AI Assistants</h2> <em>(144 examples)</em></summary>
...
| [tts-article-audio-publisher](https://raw.githubusercontent.com/team-telnyx/telnyx-code-examples/main/tts-article-audio-publisher/README.md) | Python | A scheduled Flask app that detects new/updated articles in SQLDB, generates narrated audio via Telnyx TTS, publishes to Storage with versioned CDN URLs, and tracks versions in KV. |
