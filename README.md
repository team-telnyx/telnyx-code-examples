...
| [blob-store-backup-agent](https://raw.githubusercontent.com/team-telnyx/telnyx-code-examples/main/blob-store-backup-agent/README.md) | Typescript | A Telnyx Edge agent that schedules 24h backups from BlobStore to Cloud Storage, verifies checksums, logs to SQL, and sends SMS notifications. |
