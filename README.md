...
| [tts-article-audio-publisher](https://raw.githubusercontent.com/team-telnyx/telnyx-code-examples/main/tts-article-audio-publisher/README.md) | Python | Publish article text as audio via Telnyx Text-to-Speech over SIP calls. |
