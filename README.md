...
| [sql-migration-agent](https://raw.githubusercontent.com/team-telnyx/telnyx-code-examples/main/sql-migration-agent/README.md) | Typescript | Agent that orchestrates SQL schema migrations across actor instances with version tracking, rollback, and SMS notifications via Telnyx. |
