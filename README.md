...
| [ai-lab-results-notification-voice-python](https://raw.githubusercontent.com/team-telnyx/telnyx-code-examples/main/ai-lab-results-notification-voice-python/README.md) | Python | Create a Telnyx AI Assistant for HIPAA-compliant lab results workflows that verifies patients, delivers normal lab result summaries, sends secure portal links over SMS, and escalates abnormal results to a nurse. |
