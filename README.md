...
| [persistent-state-agent](https://raw.githubusercontent.com/team-telnyx/telnyx-code-examples/main/persistent-state-agent/README.md) | Node.js | Voice-first durable customer actor on Telnyx Edge Compute with LangGraph orchestration, Salesforce CRM integration, AgentMail SDR confirmation, and proactive SMS — the actor is the customer, not the conversation. |
