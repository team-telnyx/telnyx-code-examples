...
| [multi-tenant-voice-platform](https://raw.githubusercontent.com/team-telnyx/telnyx-code-examples/main/multi-tenant-voice-platform/README.md) | Typescript | A white-label voice platform where each tenant gets isolated rate limiting, configuration, and call state within a single Telnyx Edge deployment. |
