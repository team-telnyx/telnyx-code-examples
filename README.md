...
| [agent-state-snapshot-restore](https://raw.githubusercontent.com/team-telnyx/telnyx-code-examples/main/agent-state-snapshot-restore/README.md) | Typescript | Snapshot agent state to BlobStore, log to SQL registry, and restore from backup using the Telnyx Agent SDK. |
