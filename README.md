...
| [ai-call-summarizer](https://raw.githubusercontent.com/team-telnyx/telnyx-code-examples/main/ai-call-summarizer/README.md) | Typescript | A Telnyx Edge Agent that detects call hangups, summarizes conversation history via OpenAI, texts the summary to the caller, and logs it to SQL for analytics. |
