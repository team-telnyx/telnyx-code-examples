...
Retrieve data from `/survey/status/:phoneNumber`.
...
Retrieve data from `/survey/responses/:phoneNumber`.
...
```bash
curl http://localhost:5000/survey/responses/:phoneNumber
```
