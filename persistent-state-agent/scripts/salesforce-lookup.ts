...
import { lookupLatestLead, resetSalesforceAuthCache, salesforceConfig } from "../src/salesforce.js";
...
try {
  ...
  console.error(JSON.stringify({
    ok: false,
    error: error instanceof Error ? error.message : "unknown Salesforce lookup error",
  }, null, 2));
  process.exit(1);
}
